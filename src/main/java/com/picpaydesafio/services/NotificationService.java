...
public class NotificationService {
    ...
    public void sendNotification(User user, String message) throws Exception {
        ...
        /*
        * ResponseEntity<String> notiticationResponse = restTemplate.postForEntity("https://run.mocky.io/v3/54dc2cf1-3add-45b5-b5a9-6bf7e7f1f4a6", notificationRequest, String.class);

        if (!(notiticationResponse.getStatusCode() == HttpStatus.OK)){
